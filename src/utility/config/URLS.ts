export default new class URLS {
    ...
    kahootbot_internal = 'http://just-another-kahoot-bot-internal.just-another-kahoot-bot.svc.cluster.local:8000';

    kahootbot_external = 'http://192.168.70.20:30005';
    kahootbot_local = 'http://127.0.0.1:8000'
};